    ...
    {:else}
        ...
        <form on:submit|preventDefault class="content-center place-content-center justify-center max-w-md mx-auto flex flex-col items-center gap-4">
            ...
            <div class="content-center place-content-center grid grid-cols-1 grid-rows-2 flex-auto items-center gap-3">
                <button on:click={signup} class="py-2 px-8 justify-center rounded-md border-rounded border-2 bg-gray-300 hover:bg-gray-500 hover:text-gray-300">Sign Up</button>
                <button on:click={login} class="py-3 px-8 justify-center rounded-md border-1 bg-emerald-300 hover:bg-emerald-600 hover:text-emerald-300">Log In</button>
            </div>
